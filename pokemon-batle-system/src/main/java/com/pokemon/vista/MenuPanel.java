...
public class MenuPanel extends JPanel {
    ...
    private JButton crearBoton(String texto) {
        ...
        // Aplicar estilo consistente (incluye hover y estado disabled legible)
        ComponentStyles.styleButton(boton,
            new Color(220, 50, 50), // normal
            new Color(255, 70, 70), // hover
            Color.BLACK,            // foreground (cambia a negro)
            new Color(255, 215, 0), // border
            new Color(200, 200, 200), // disabled background (legible)
            Color.DARK_GRAY         // disabled foreground
        );
